...
- live loop event handling for rejected command, retrying capture, follow-up listening, accepted command and follow-up, assistant response, sleeping state, wake score, provider, RMS, VAD diagnostics, raw speech, interpreted speech, repair confidence, and repair strategy
